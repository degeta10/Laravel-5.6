...
<!-- Scripts -->
    ...
    <!-- Plugin JS Files -->
    <script type="text/javascript" src="{{ asset('js/plugins/form-validate.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('js/plugins/bootstrap-datepicker.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('js/plugins/bootstrap-select.min.js')}}"></script>
